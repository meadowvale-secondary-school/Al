 ...
 */
var al = User(name: "Al", age: 12, height: 175, weight: 90000, activityLevel: -59595)
print(al.name,al.age,al.height,al.weight,al.activityLevel)
/*:
...
struct Distance{
    ...
    init (inFeet:Double) {
        inM = inFeet / 3.28084
        inKm = inFeet / 3.28084 / 1000
        self.inFeet = inFeet
    }
    init(inKm:Double) {
        inM = inKm * 1000
        inFeet = inKm / 1000 * 3.28084
        self.inKm = inKm
    }
 ...
 */
var mile = Distance(inM: 1600)

print(mile.inFeet,mile.inKm)
/*:
 Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
 */
mile = Distance(inFeet: 3.28084)
print(mile.inM,mile.inKm)
