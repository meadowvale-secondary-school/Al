...
struct Height {
    ...
    var heightInCentimeters: Double{
        didSet {
            let inIn = heightInCentimeters/2.54
            if inIn != heightInInches{
...
var tree = Height(heightInInches: 5)
print("F")
print(tree.heightInCentimeters,tree.heightInInches)

tree.heightInCentimeters = 1
print("ghj")
print(tree.heightInCentimeters,tree.heightInInches)
