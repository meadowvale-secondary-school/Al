 ...
 */
let possiblemac = Computer(ram: 25, yearManufactured: 2015)
if let mac = possiblemac{
    print(possiblemac?.ram, possiblemac?.yearManufactured)
}

if let possibleMac = Computer(ram: 25, yearManufactured: 2015){
    print(possibleMac.ram)
}

if let possibleAcer = Computer(ram: 0, yearManufactured: 2015){
    print(possiblemac.ram)
}
